...
var inputPrompt = "Give me a " + level + " level, 7-day diet plan with a focus on the following foods:" + foods.join(', ') + ". ";
        ...
        for (let i = 1; i < paragraphs.length; i++) {
            ...
            for (let j = 1; j < day.length; j++) {
                ...
                try {
                    ...
                    if (nutritionalInfo == null) { throw new Error("nutritionalInfo is null.") };
                } catch (error) {
