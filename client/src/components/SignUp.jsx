      ...
      <div className={`card-body ${styles.signupCard}`}>
        ...
        <form id={styles.signup} onSubmit={handleSubmit}>
          ...
          <input
            ...
            required
          />
          <label htmlFor="firstName" className={`${styles.inputLabel}`}><span className={`${styles.inputName}`}>First Name</span></label>
          ...
          <input
            ...
            required
          />
          <label htmlFor="lastName" className={`${styles.inputLabel}`}><span className={`${styles.inputName}`}>Last Name</span></label>
          ...
          <input
            ...
            required
          />
          <label htmlFor="email" className={`${styles.inputLabel}`}><span className={`${styles.inputName} ${styles.emailPlaceholder}`}>Email</span></label>
          ...
          <input
            ...
            required
          />
          <label htmlFor="password" className={`${styles.inputLabel}`}><span className={`${styles.inputName}`}>Password</span></label>
