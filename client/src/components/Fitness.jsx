...
async function getWorkout() {
  var response = await fetch(`https://healthify-olh6.onrender.com/fitness/${userEmail}`, {
    method: "GET",
...
const Fitness = () => {
  ...
  async function addWorkoutToUser(event) {
    ...
    const response = await fetch(`https://healthify-olh6.onrender.com/fitness/${userEmail}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json", },
